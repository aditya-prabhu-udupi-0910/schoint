...
app.config['MAIL_USERNAME'] = '5407435.adityaprabhu@gmail.com'
app.config['MAIL_PASSWORD'] = 'kaoa chug rjcz ajne'
app.config['MAIL_DEFAULT_SENDER'] = ('Schoint Finder', '5407435.adityaprabhu@gmail.com')
...
def add_scholarship():
    ...
    return render_template("submit.html")  # or whatever your form template is
    ...
    if request.method == "POST":
        ...
        try:
            ...
            msg = Message(
                ...
                recipients=["5407435.adityaprabhu@gmail.com"],  # Your email
                body=f"Name: {name}\nEmail: {email}\n\nMessage:\n{message_body}"
            )
